                ...
                <form role="form" action="{{ route('store')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="prix" class="form-control" placeholder="Enter ...">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        @foreach($categorie as $cate)
                         <option value="{{$cate->titre }}">{{$cate->titre }}</option>
                          @endforeach
                      </select>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>langue</label>
                        <input type="text" name="langue" class="form-control" placeholder="Enter ...">
                      </div>
                    </div>
                  </div>
                  <div class="row">
